...
export default  class TableData  {
  ...
  @observable recordsLength = 0;

  @action setPage(page:number) { this.page = page}
  @action setRowsPerPage(rowsPerPage:number){ this.rowsPerPage = rowsPerPage}
  ...
  @computed get paginationValues():number[]{
    let result = PAGINATION_VALUES_DEFAULT.filter(value => value < this.recordsLength);
    result.push(this.recordsLength);
    return result;
  } 
